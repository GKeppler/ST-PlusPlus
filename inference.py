...
def main(args):
    ...
    model.module.load_state_dict(torch.load(r"outdir/models/melanoma/1_30/split_0/unet_resnet50_87.46.pth", map_location="cuda:0"))
    best_model = model
    ...
    testloader = DataLoader(testset, 1, shuffle=False, pin_memory=True, num_workers=2, drop_last=False)
